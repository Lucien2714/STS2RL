"""Trainable candidate-action DQN battle agent.

The state/action encoding and legal-action enumeration live in
:class:`sts2rl.encoders.battle_encoder.BattleStateEncoder`, composed via
:class:`sts2rl.agents.battle.base.CandidateActionAgent`. This module keeps only
the DQN network, replay buffer, and training/inference logic.
"""
...
class BattleDQNAgent(CandidateActionAgent):
